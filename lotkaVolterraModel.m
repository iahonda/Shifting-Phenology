...
% MATLAB code for the Lotka-Volterra model (Discussion and Figure S9)
% Adapted from model provided by Greg L. Britten
% Isabel Honda
% May 2024

%% Lotka-Volterra Model (Appendix S1, Figure S9)
...
z_g = 0.08; % zooplankton grazing rate on phytoplankton
c_g = 0.1; % consumer grazing rate on zooplankton
c_m = 0.07; % consumer mortality
c_emerge = 120/dt; % predators appear at day 180
